    ...
    internal class DreamLanternFix : NomaiVRModule<NomaiVRModule.EmptyBehaviour, DreamLanternFix.Patch>
    {
        ...
        public class Patch : NomaiVRPatch
        {
            ...
            public static void FixupModel(DreamLanternItem __instance)
            {
                ...
                {
                    viewModelTransform.localRotation = Quaternion.identity;
                    viewModelTransform.localPosition = new Vector3(0, 0.35f, 0);
                ...
                {
                    prortotypeViewModelTransform.localRotation = Quaternion.identity;
                    prortotypeViewModelTransform.localPosition = Vector3.zero;
                }
