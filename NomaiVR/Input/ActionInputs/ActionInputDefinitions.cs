...
namespace NomaiVR.Input.ActionInputs
{
    public static class ActionInputDefinitions
    {
        ...
        public static readonly Vector2ActionInput LookY = new Vector2ActionInput(true)
        {
            SpecificAction = _default.Look
        };
        ...
        public static readonly Vector2ActionInput MoveZ = new Vector2ActionInput(true)
        {
            SpecificAction = _default.Move
        };
        ...
        public static readonly Vector2ActionInput StationaryUp = new Vector2ActionInput(true, clamp: true)
        {
            SpecificAction = tools.DPad
        };

        public static readonly Vector2ActionInput StationaryDown = new Vector2ActionInput(true, true, true)
        {
            SpecificAction = tools.DPad
        };
        ...
        public static readonly Vector2ActionInput Up = new Vector2ActionInput(true, clamp: true)
        {
            SpecificAction = _default.UIDpad
        };

        public static readonly Vector2ActionInput Down = new Vector2ActionInput(true, true, true)
        {
            SpecificAction = _default.UIDpad
        };
        ...
        public static readonly Vector2ActionInput ToolUp = new Vector2ActionInput(true, clamp: true)
        {
            SpecificAction = tools.DPad
        };

        public static readonly Vector2ActionInput ToolDown = new Vector2ActionInput(true, true, true)
        {
            SpecificAction = tools.DPad
        };
