...
namespace NomaiVR.Input
{
    ...
    {
        public static readonly Dictionary<InputCommandType, VRActionInputs.IVRActionInput> DefaultInputMap =
            new Dictionary<InputCommandType, VRActionInputs.IVRActionInput>()
            {
                ...
                { InputCommandType.PROBELAUNCH, VRActionInputs.StationaryUse },
                { InputCommandType.PROBERETRIEVE, VRActionInputs.StationaryUse },
                { InputCommandType.SCOPEVIEW, VRActionInputs.StationaryUse },
                { InputCommandType.TOOL_PRIMARY, VRActionInputs.StationaryUse },
                { InputCommandType.TOOL_UP, VRActionInputs.StationaryUp },
                { InputCommandType.TOOL_DOWN, VRActionInputs.StationaryDown },
                { InputCommandType.TOOL_RIGHT, VRActionInputs.StationaryRight },
                { InputCommandType.TOOL_LEFT, VRActionInputs.StationaryLeft },
            };

        public static readonly Dictionary<InputCommandType, VRActionInputs.IVRActionInput> ToolsInputMap =
            new Dictionary<InputCommandType, VRActionInputs.IVRActionInput>()
            {
                ...
                { InputCommandType.INTERACT, VRActionInputs.Empty },
            };
    }
}