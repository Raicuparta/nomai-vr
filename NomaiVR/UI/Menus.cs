...
namespace NomaiVR
{
    internal class Menus : NomaiVRModule<Menus.Behaviour, Menus.Behaviour.Patch>
    {
        ...
        public class Behaviour : MonoBehaviour
        {
            ...
            static void FixStarLogo(string objectName)
            {
            ...
            static void FixTitleMenuCanvases()
            {
            ...
            static void AddFollowTarget(Canvas canvas)
            {
            ...
            static void AdjustScaler(Canvas canvas)
            {
            ...
            static void AdjustModConfigButtons(Canvas canvas)
            {
            ...
            static void ScreenCanvasesToWorld()
            {
